...
public class RoundImgView extends AppCompatImageView {
    ...
    public RoundImgView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.RoundImgView, defStyleAttr, 0);

        type = a.getInt(R.styleable.RoundImgView_type, TYPE_OVAL);
        mBorderColor = a.getColor(R.styleable.RoundImgView_border_color, Color.WHITE);
        mBorderWidth = a.getDimension(R.styleable.RoundImgView_border_width, 0);
        mCornerRadius = a.getDimension(R.styleable.RoundImgView_corner_radius, dp2px(10));
        mLeftTopCornerRadius = a.getDimension(R.styleable.RoundImgView_leftTop_corner_radius, 0);
        mLeftBottomCornerRadius = a.getDimension(R.styleable.RoundImgView_leftBottom_corner_radius,0);
        mRightTopCornerRadius = a.getDimension(R.styleable.RoundImgView_rightTop_corner_radius,0);
        mRightBottomCornerRadius = a.getDimension(R.styleable.RoundImgView_rightBottom_corner_radius,0);
     ...
     * 默认为圆形图片
     */
    public RoundImgView setType(int imageType) {
     ...
     * 设置圆角图片的圆角大小
     */
    public RoundImgView setCornerRadius(int cornerRadius) {
     ...
     * 设置圆角图片的左上圆角大小
     */
    public RoundImgView setLeftTopCornerRadius(int cornerRadius) {
        cornerRadius = dp2px(cornerRadius);
     ...
     * 设置圆角图片的右上圆角大小
     */
    public RoundImgView setRightTopCornerRadius(int cornerRadius) {
        cornerRadius = dp2px(cornerRadius);
     ...
     * 设置圆角图片的左下圆角大小
     */
    public RoundImgView setLeftBottomCornerRadius(int cornerRadius) {
        cornerRadius = dp2px(cornerRadius);
     ...
     * 设置圆角图片的右下圆角大小
     */
    public RoundImgView setRightBottomCornerRadius(int cornerRadius) {
        cornerRadius = dp2px(cornerRadius);
     ...
     * 设置描边宽度
     */
    public RoundImgView setBorderWidth(int borderWidth) {
     ...
     * 设置描边颜色
     */
    public RoundImgView setBorderColor(int borderColor) {
