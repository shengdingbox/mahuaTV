...
//    private EndBean endBean = new EndBean("我是有底线的");
    ...
    public static void start(String zlass, TypeBean type) {
        Intent intent = new Intent(App.getInstance().getContext(), ScreenActivity.class);
...
//                                    isEnd = true;
//                                    if (mPage == 1) {
//                                        endBean.setText("肚子没东西了");
//                                    } else {
//                                        endBean.setText("我是有底线的");
//                                    }
//                                    itmes.add(endBean);
                                } else {
                                    setResultData(list);
